...
Use the [`interpolate` expression](https://docs.goong.io/style-spec/expressions/#interpolate) to ease-in the building layer and smoothly fade from one color to the next.
