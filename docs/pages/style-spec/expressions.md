...
The value for any [layout property](https://docs.goong.io/docs/style-spec/layers/#layout-property), [paint property](https://docs.goong.io/docs/style-spec/layers/#paint-property), or [filter](https://docs.goong.io/docs/style-spec/layers/#filter) may be specified as an _expression_. An expression defines a formula for computing the value of the property using the _operators_ described below. The set of expression operators provided by Goong GL includes:
